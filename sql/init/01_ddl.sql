...
--
-- SOURCE / PROVENANCE:
-- Downloaded verbatim from OHDSI/CommonDataModel, tag v5.4.0:
--   https://github.com/OHDSI/CommonDataModel/blob/v5.4.0/inst/ddl/5.4/postgresql/OMOPCDM_postgresql_5.4_ddl.sql
-- LOCAL MODIFICATION: the SqlRender placeholder "@cdmDatabaseSchema" was replaced
-- with the literal schema name "cdm" (this repo always uses a schema named "cdm").
-- No other changes were made to this file. See 03_constraints.sql for one
-- upstream constraint that had to be commented out and why.
